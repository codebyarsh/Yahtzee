...
class Game extends Component {
  constructor(props) {
    ...
    this.animaeroll = this.animaeroll.bind(this);
  }
  ...
  toggleLocked(idx) {
    ...
    if (this.state.rollsLeft > 0 && !this.props.rolling) {
      this.setState((st) => ({
        locked: [
    ...
    return (
      <div className="Game Container">
        <header className="Game-header">
          <h1 className="App-title">Let's Play Yahtzee</h1>
